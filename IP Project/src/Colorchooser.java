...
static Color myMalletColor = Color.red;
static Color oppMalletColor = Color.red;
static Color puckColor = Color.blue;
static Color bgColor = Color.lightGray;

public void paint(Graphics g){
    g.setColor(color);
    g.drawOval(150, 250, 24, 24);
    g.fillOval(150, 250, 24, 24);
    if(Airhockey.i==4)
